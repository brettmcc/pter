...
estimates store model3 //rerun with this as model3

estfe . model1 model2 model3, labels(monthly_date "Year-month FE" cpsdip "Individual FE")

esttab . model1 model2 model3 using eq1.csv, indicate(`r(indicate_fe)' ) p 
