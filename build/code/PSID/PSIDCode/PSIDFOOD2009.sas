...
set psiddata.fam05;
id2005 = ER25002;
if ER25688 ne 0 then do; fdhm = ER25688; hmper = ER25689; end;
else do; fdhm = ER25698; hmper = ER25699; end;
if ER25695 ne 0 then do; fdout = ER25695; outper = ER25696;  end;
else do; fdout = ER25705; outper = ER25706; end;
%food
foodhome2005 = fdhm;
foodout2005 = fdout;
food2005 = food;
keep id2005 foodhome2005 foodout2005 food2005;
proc univariate;
var food2005;
...
set psiddata.fam07;
id2007 = ER36002;
if ER36706 ne 0 then do; fdhm = ER36706; hmper = ER36707; end;
else do; fdhm = ER36716; hmper = ER36717; end;
if ER36713 ne 0 then do; fdout = ER36713; outper = ER36714;  end;
else do; fdout = ER36723; outper = ER36724; end;
%food;
foodhome2007 = fdhm;
foodout2007 = fdout;
food2007 = food;
keep id2007 foodhome2007 foodout2007 food2007;
proc univariate;
var food2007;
...
set psiddata.fam09;
id2009 = ER42002;
if ER42712 ne 0 then do; fdhm = ER42712; hmper = ER42713; end;
else do; fdhm = ER42722; hmper = ER42723; end;
if ER42719 ne 0 then do; fdout = ER42719; outper = ER42720; end;
else do; fdout = ER42729; outper = ER42729; end;
%food;
foodhome2009 = fdhm;
foodout2009 = fdout;
food2009 = food;
keep id2009 foodhome2009 foodout2009 food2009;
proc univariate;
var food2009;

data psiddata.psidfood19682009;
merge food1968 food1969 food1970 food1971 food1972 food1974 food1975 food1976 food1977 food1978 food1979 
	  ...
	  food2001 food2003 food2005 food2007 food2009;


%macro pfood(year);
data pfood;
set psiddata.psidfood19682009;
if id&year ne .;
if food&year > 0;
proc univariate;
var food&year;
